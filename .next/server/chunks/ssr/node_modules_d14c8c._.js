...
"[project]/node_modules/@babel/runtime/helpers/esm/objectSpread.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-json-editor-ajrm/es/themes.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-json-editor-ajrm/es/locale/en.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-json-editor-ajrm/es/locale/index.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-json-editor-ajrm/es/mitsuketa/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
        ...
        switch(getType(identity)){
            case 'array':
                ...
                if (maxDepth !== null ? currentDepth < maxDepth : true) for(var i = 0, l = keys.length; i < l; i++){
                    const key = keys[i], subIdentity = identity[key];
 ...
 */ function maxDepth(identity, maxLayer = null) {
    ...
    function _maxDepth(identity, maxLayer, currentDepth = 0) {
        ...
        if (maxLayer !== null) {
            if (currentDepth >= maxLayer) return;
        }
        if (isIterable(identity)) {
 ...
 */ function singleProperty(identity) {
    ...
    if (propCount === 0) {
        if ([
            'string',
            'number'
        ].indexOf(getType(identity)) > -1) return identity;
    }
    return false;
}
/**
 ...
 */ function falser(identity) {
    ...
    if ([
        'null',
        'undefined'
    ].indexOf(getType(identity)) > -1) return false;
    if ([
        '',
        0,
        false
    ].indexOf(identity) > -1) return false;
    return identity;
}
/**
 ...
 */ function length(identity) {
    if ([
        'array',
        'object'
    ].indexOf(getType(identity)) === -1) return 0;
 ...
 */ function deepFilter(collection, identity, maxDepth = null) {
    ...
    const results = paths.map((path)=>{
        ...
        if ([
            'array',
            'object'
        ].indexOf(getType(identity)) === -1) path.splice(-1, 1);
        var result = collection;
        if (!Array.isArray(path)) return result[path];
        path.forEach((key)=>{
            result = result[key];
 ...
 */ function trim(identity, keyList) {
    ...
    if ([
        'array',
        'object'
    ].indexOf(identityType) === -1) return undefined;
 ...
 */ function identical(identityA, identityB) {
    ...
    if ([
        'array',
        'object'
    ].indexOf(structureMatch) === -1) return identityA === identityB;
...
"[project]/node_modules/react-json-editor-ajrm/es/err.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-json-editor-ajrm/es/mitsuketa/index.js [app-rsc] (ecmascript)");
;
const err = {
    getCaller: (skip = 1)=>{
    ...
    isUndefined: (paramName = '<unknown parameter>', param)=>{
        if ([
            null,
            undefined
        ].indexOf(param) > -1) err.throwError(err.getCaller(2), paramName);
    },
    ...
    isNotType: (paramName = '<unknown parameter>', param, type = '')=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getType"])(param) !== type.toLowerCase()) err.throwError(err.getCaller(2), paramName, 'to be type ' + type.toLowerCase());
    },
    isAnyTypeOf: (paramName = '<unknown parameter>', param, types = [])=>{
        types.forEach((type)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getType"])(param) === type) err.throwError(err.getCaller(2), paramName, 'not to be type of ' + type.toLowerCase());
        });
    },
    ...
    containsUndefined: (paramName = '<unknown parameter>', param)=>{
        [
            ...
            const location = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["locate"])(param, value);
...
const __TURBOPACK__default__export__ = err;
}}),
"[project]/node_modules/react-json-editor-ajrm/es/index.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$objectSpread$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@babel/runtime/helpers/esm/objectSpread.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$themes$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-json-editor-ajrm/es/themes.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$en$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-json-editor-ajrm/es/locale/en.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-json-editor-ajrm/es/locale/index.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-json-editor-ajrm/es/mitsuketa/index.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$err$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-json-editor-ajrm/es/err.js [app-rsc] (ecmascript)");
;
;
;
;
...
;
;
class JSONInput extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Component"] {
    constructor(props){
        super(props);
    ...
    updateInternalProps() {
        let colors = {}, style = {}, theme = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$themes$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].dark_vscode_tribute;
        if ('theme' in this.props) {
            if (typeof this.props.theme === 'string') {
                if (this.props.theme in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$themes$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]) theme = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$themes$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"][this.props.theme];
            }
        }
        colors = theme;
    ...
    render() {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("div", {
            name: "outer-box",
            id: id && id + '-outer-box',
            style: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$objectSpread$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
                display: 'block',
                overflow: 'none',
                height: totalHeight,
                width: totalWidth,
        ...
        }, confirmGood ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("div", {
            style: {
        ...
        }))) : void 0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("div", {
            name: "container",
            id: id && id + '-container',
            style: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$objectSpread$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
                display: 'block',
            ...
            onClick: this.onClick
        }, this.renderErrorMessage())), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("div", {
            name: "body",
            id: id && id + '-body',
            style: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$objectSpread$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
                display: 'flex',
            ...
            onClick: this.onClick
        }, this.renderLabels()), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("span", {
            id: id,
    ...
    renderErrorMessage() {
        const locale = this.props.locale || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$en$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], error = this.props.error || this.state.error, style = this.style;
        if (!error) return void 0;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("p", {
            style: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$objectSpread$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
                color: 'red',
                fontSize: '12px',
                position: 'absolute',
        ...
        }, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.format, error));
    }
    renderLabels() {
        ...
        return labels.map((number)=>{
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createElement("div", {
                key: number,
                style: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$objectSpread$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({}, style.labels, {
                    color: color
                })
            }, number);
        });
    ...
    showPlaceholder() {
        ...
        const placeholderDataType = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getType"])(placeholder);
        const unexpectedDataType = [
            'object',
            'array'
        ].indexOf(placeholderDataType) === -1;
        if (unexpectedDataType) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$err$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].throwError('showPlaceholder', 'placeholder', 'either an object or an array');
        const samePlaceholderValues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["identical"])(placeholder, prevPlaceholder); // Component will always re-render when new placeholder value is any different from previous placeholder value.
         ...
         */ if (jsObject !== undefined) componentShouldUpdate = !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$mitsuketa$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["identical"])(placeholder, jsObject);
            }
        }
    ...
    tokenize(something) {
        ...
        const locale = this.props.locale || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$en$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"];
     ...
     */ if ('nodeType' in something) {
            ...
            const quotes = '\'"', alphanumeric = 'abcdefghijklmnopqrstuvwxyz' + 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' + '0123456789' + '_$';
                ...
                switch(type){
                    ...
                    case 'symbol':
                        switch(string){
                            ...
                            case '[':
                                ...
                                if (found) {
                                    setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.tokenSequence.prohibited, {
                                ...
                                if (string === '[' && i > 0) {
                                    if (!followsSymbol(i, [
                                        ...
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.tokenSequence.permitted, {
                                            firstToken: "[",
                                            secondToken: [
                                                ":",
                                                "[",
                                ...
                                if (string === '{') {
                                    if (followsSymbol(i, [
                                        ...
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.double, {
                                            token: "{"
                                        }));
                                        break;
                                    }
                            ...
                            case ']':
                                if (string === '}') {
                                    if (buffer2.brackets[buffer2.brackets.length - 1] !== '{') {
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.brace.curly.missingOpen));
                                        break;
                                    }
                                }
                                if (string === '}') {
                                ...
                                if (string === ']') {
                                    if (buffer2.brackets[buffer2.brackets.length - 1] !== '[') {
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.brace.square.missingOpen));
                                        break;
                                    }
                                }
                                if (string === ']') {
                            ...
                            case ',':
                                ...
                                if (found) {
                                    if (followedBySymbol(i, [
                                        ...
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.brace.curly.cannotWrap, {
                                            token: ","
                                        }));
                                        break;
                                    }
                                ...
                                if (followedBySymbol(i, [
                                    ...
                                    setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.noTrailingOrLeadingComma));
                                    break;
                                }
                                ...
                                switch(found){
                                    case 'key':
                                    case 'colon':
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.termSequence.prohibited, {
                    ...
                    case 'colon':
                        ...
                        if (found && followedBySymbol(i, [
                            ...
                            setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.brace.square.cannotWrap, {
                                token: ":"
                            }));
                            break;
                        }
                        ...
                        if (typeFollowed(i) !== 'key') {
                            setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.termSequence.permitted, {
                    ...
                    case 'string':
                        ...
                        if (quotes.indexOf(firstChar) === -1) {
                            if (quotes.indexOf(lastChar) !== -1) {
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.string.missingOpen, {
                                    quote: firstChar
                                }));
                                break;
                            }
                        ...
                        if (quotes.indexOf(lastChar) === -1) {
                            if (quotes.indexOf(firstChar) !== -1) {
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.string.missingClose, {
                                    quote: firstChar
                                }));
                                break;
                            }
                        ...
                        if ('string' === type) {
                            if (quotes.indexOf(firstChar) === -1 && quotes.indexOf(lastChar) === -1) {
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.string.mustBeWrappedByQuotes));
                                break;
                            }
                        }
                        if ('key' === type) {
                        ...
                        if (quotes.indexOf(firstChar) === -1 && quotes.indexOf(lastChar) === -1) for(var h = 0; h < string.length; h++){
                            ...
                            if (alphanumeric.indexOf(c) === -1) {
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.string.nonAlphanumeric, {
                                    token: c
                                }));
                                break;
                            }
                            ...
                            if ('key' === typeFollowed(i)) {
                                if (i > 0) {
                                    if (!isNaN(buffer.tokens_merge[i - 1])) {
                                        ...
                                        setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.key.numberAndLetterMissingQuotes));
                                        break;
                                    }
                                }
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.key.spaceMissingQuotes));
                                break;
                            }
                        }
                        if ('key' === type) {
                        ...
                        if ('key' === type) {
                            if (buffer2.isValue) {
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.string.unexpectedKey));
                                break;
                            }
                        }
                        if ('string' === type) {
                            if (!buffer2.isValue) {
                                setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.key.unexpectedString));
                                break;
                            }
                        }
                        buffer.json += string;
                    ...
                    case 'primitive':
                        ...
                        if (type === 'primitive') {
                            if (string === 'undefined') setError(i, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.useInstead, {
                                badToken: "undefined",
                                goodToken: "null"
                            }));
                        }
            ...
            if (!error) {
                ...
                while(bracketList.length > 0){
                    ...
                    for(var tokenCount = 0; tokenCount < bracketList.length - 1; tokenCount++){
                        ...
                        if ([
                            '[]',
                            '{}'
                        ].indexOf(pair) > -1) removePair(tokenCount);
                    }
                    round++;
                    if (!delta) break;
                ...
                if (bracketList.length > 0) {
                    ...
                    setError(_tokenPosition, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.brace[_closingBracketType === ']' ? 'square' : 'curly'].missingClose));
                }
            }
            if (!error) {
                if ([
                    undefined,
                    ''
                ].indexOf(buffer.json) === -1) try {
                    buffer.jsObject = JSON.parse(buffer.json);
                } catch (err) {
                    const errorMessage = err.message, subsMark = errorMessage.indexOf('position');
                    ...
                    let charTotal = 0, tokenIndex = 0, token = false, _line = 1, exitWhile = false;
                    while(charTotal < errPosition && !exitWhile){
                        ...
                        if ([
                            'space',
                            'linebreak'
                        ].indexOf(token.type) === -1) charTotal += token.string.length;
                        ...
                        if (char === '\\') backslashCount = backslashCount > 0 ? backslashCount + 1 : 1;
                            ...
                            if (backslashCount % 2 !== 0 || backslashCount === 0) {
                                if ('\'"bfnrt'.indexOf(char) === -1) {
                                    setError(tokenIndex, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.unexpected, {
                                        token: '\\'
                                    }));
                                }
                            }
                    ...
                    if (!error) setError(tokenIndex, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$json$2d$editor$2d$ajrm$2f$es$2f$locale$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["format"])(locale.invalidToken.unexpected, {
                        token: token.string
                    }));
                }
            }
                ...
                switch(type){
                    ...
                    case 'symbol':
                        switch(string){
                            ...
                            case '}':
                                _depth--;
                                const islastToken = i === buffer.tokens_merge.length - 1, _adjustment = i > 0 ? [
                                    '[',
                                    '{'
                                ].indexOf(buffer.tokens_merge[i - 1].string) > -1 ? '' : newLineBreakAndIndent(islastToken) : '';
            ...
            for(var i = 0; i < buffer.tokens_merge.length; i++){
                ...
                if ([
                    'space',
                    'linebreak'
                ].indexOf(token.type) === -1) buffer.tokens_plainText += token.string;
            }
            if (error) {
                ...
                switch(token){
                    ...
                    default:
                        ...
                        function stripQuotesFromKey(text) {
                            ...
                            const nonAlphaNumeric = text.replace(/\w/g, ''), alphaNumeric = text.replace(/\W+/g, ''), mayRemoveQuotes = ((nonAlphaNumeric, text)=>{
                            ...
                            })(nonAlphaNumeric, text), hasQuotes = ((string)=>{
                                for(var i = 0; i < string.length; i++){
                                    if ([
                                        "'",
                                        '"'
                                    ].indexOf(string.charAt(i)) > -1) return true;
                                }
                                return false;
                            })(nonAlphaNumeric);
                            if (hasQuotes) {
...
const __TURBOPACK__default__export__ = JSONInput;
}}),

};

//# sourceMappingURL=node_modules_d14c8c._.js.map